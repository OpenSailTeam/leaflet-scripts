...
(function () {
  ...
  (function () {
    ...
    function runQueuedJob(job) {
      if (typeof job !== "function") return 0;
      try {
        job(window.KHMaps);
      } catch (err) {
        console.error("KHMaps queue job failed", err);
      }
      return 1;
    }
